...
export const POETIC_RULES = compileRules({
  ...
  a: [
    ...
    [/a(?=cia|bou|(?:gu?|[bcdfklmnptvz])(?:in|e))/, 'ɛj'],
    [/a(?=mi)/, 'ɛj', /./],
  ...
  e: [
    ...
    [`e(?=cial|vel|qu(?!a)|ck|rc|[fp]t|s(?:k|qu|t)|sc(?!i)|c[^${VOWELS}]|t[^${VOWELS}h]|du|cio|m(?![${VOWELS}])|[klnxz]|ts?$)`, 'ɛ'],
    [/e(?=f)/, 'ɛ', /^d$/, NEGATIVE],
    [/e(?=v$)/, 'ɛ'],
