...
export const POETIC_RULES = compileRules({
  ...
  e: [
    ...
    [`e(?=vel|qu(?!a)|ck|rc|[fp]t|s(?:k|qu|t)|sc(?!i)|c[^${VOWELS}]|t[^${VOWELS}h]|cio|m(?![${VOWELS}])|[klnxz]|ts?$)`, 'ɛ'],
    [/e(?=f)/, 'ɛ', /^d$/, NEGATIVE],
    [/e(?=v$)/, 'ɛ'],
